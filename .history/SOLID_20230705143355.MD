...
La classe Employee de la partie Core a une seule responsabilité, qui est de représenter un employé avec ses propriétés.
...
---
       . Principe de Ségrégation de l'Interface (ISP)
